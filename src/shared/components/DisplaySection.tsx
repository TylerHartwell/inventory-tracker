    ...
    <section className="rounded border border-gray-700 p-2 flex flex-col gap-2">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          title={isExpanded ? "Collapse display controls" : "Expand display controls"}
        >
      ...
      {isExpanded && (
        <>
          <div id="display-section-controls" className="flex items-center justify-start gap-3 flex-wrap min-w-0">
            <LayoutControl
              layoutMode={layoutMode}
              gridColumns={gridColumns}
